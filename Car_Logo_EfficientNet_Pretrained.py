...
for epoch in range(epochs):
    ...
    if v_f1 > best_f1:
        best_f1 = v_f1
        epochs_no_improve = 0
        torch.save(model.state_dict(), "best_efficientnet_b0_weights.pth")
    else:
        epochs_no_improve += 1
...
if os.path.exists("best_efficientnet_b0_weights.pth"):
    model.load_state_dict(torch.load("best_efficientnet_b0_weights.pth"))
...
plt.title("EfficientNet-B0 Precision & Recall")
plt.legend()

plt.subplot(2, 2, 4)
plt.plot(history["val_f1"], label="Val F1 Score")
plt.title("EfficientNet-B0 F1 Score")
plt.legend()

plt.tight_layout()
plt.savefig("efficientnet_b0_metrics.png")
print("Metrics graph saved as efficientnet_b0_metrics.png")
plt.show()
...
plt.ylabel("Actual")
plt.tight_layout()
plt.savefig("efficientnet_b0_confusion_matrix.png")
print("Confusion matrix saved as efficientnet_b0_confusion_matrix.png")
plt.show()
