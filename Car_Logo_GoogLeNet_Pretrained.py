...
for epoch in range(epochs):
    ...
    if v_f1 > best_f1:
        best_f1 = v_f1
        epochs_no_improve = 0
        torch.save(model.state_dict(), "best_googlenet_weights.pth")
    else:
        epochs_no_improve += 1
...
if os.path.exists("best_googlenet_weights.pth"):
    model.load_state_dict(torch.load("best_googlenet_weights.pth"))
...
plt.title("GoogLeNet Precision & Recall")
plt.legend()

plt.subplot(2, 2, 4)
plt.plot(history["val_f1"], label="Val F1 Score")
plt.title("GoogLeNet F1 Score")
plt.legend()

plt.tight_layout()
plt.savefig("googlenet_metrics.png")
print("Metrics graph saved as googlenet_metrics.png")
plt.show()
...
print("Confusion matrix saved as googlenet_confusion_matrix.png")
plt.show()
