...
for epoch in range(epochs):
    ...
    if v_f1 > best_f1:
        best_f1 = v_f1
        epochs_no_improve = 0
        torch.save(model.state_dict(), "best_resnet50_weights.pth")
    else:
        epochs_no_improve += 1
...
if os.path.exists("best_resnet50_weights.pth"):
    model.load_state_dict(torch.load("best_resnet50_weights.pth"))
...
print("Metrics graph saved as resnet50_metrics.png")
plt.show()
